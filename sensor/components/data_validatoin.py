...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        ...
        df: Accepts a pandas as dataframe
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            logging.info(f"Drop null vlaue columns from base df")
            ...
            test_df = self.drop_missing_values_columns(df = test_df, report_key_name = "missing_vlaues_within_test_dataset")
